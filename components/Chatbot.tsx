      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4 max-h-[400px] min-h-[300px] bg-[#F7F5F0]">
              ...
              {isLoading && (
                <div className="flex gap-3 justify-start">
                  ...
                  <div className="p-3 rounded-2xl bg-white border border-[#E7DED1] text-[#37454A] rounded-tl-none shadow-sm flex items-center">
                    <Loader2 className="w-4 h-4 animate-spin text-[#7895A3]" />
                  </div>
                </div>
              )}
            ...
            {/* Input */}
            <div className="p-3 border-t border-[#E7DED1] bg-white">
